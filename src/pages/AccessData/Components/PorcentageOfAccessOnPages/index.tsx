...
const PorcentageOfAccessOnPages = () => {
    ...
    series: [
      {
        ...
        data: [
          {
            x: analyticsDataState?.totalAccessOnPages?.expertsClub?.value,
            y: analyticsDataState?.totalAccessOnPages?.expertsClub?.porcentage,
            color: AnalyticsColors.ecWine,
            name: 'Experts Club',
          },
          {
            x: analyticsDataState?.totalAccessOnPages?.ignite?.value,
            y: analyticsDataState?.totalAccessOnPages?.ignite?.porcentage,
  ...
  return (
    <S.Wrapper>
      <S.TotalOfAccess>
        <span><b>{analyticsDataState?.totalAccessOnPages?.all}</b> Acessos</span>
      </S.TotalOfAccess>
